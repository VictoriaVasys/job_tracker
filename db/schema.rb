...
ActiveRecord::Schema.define(version: 20170409214749) do
  ...
  add_index "jobs", ["job_tag_id"], name: "index_jobs_on_job_tag_id", using: :btree
  ...
  add_index "tags", ["job_tag_id"], name: "index_tags_on_job_tag_id", using: :btree
